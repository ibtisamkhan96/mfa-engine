...
def build_context(**kwargs: object) -> str:
    ...
    add("  End-of-life recovery assumption", kwargs.get("recovery_regime"))
    add("  End-of-life recycling rate applied", kwargs.get("recovery_rate"))
    add("  Average annual end-of-life outflow (tonnes leaving service)", kwargs.get("gross_outflow_t"))
    add("  Average annual recovered (tonnes actually recycled back into use)", kwargs.get("recovered_t"))
